...
object Proveedores : IntIdTable("proveedores") {
    ...
    val contactoNombre = varchar("contacto_nombre", 200)
    val contactoEmail = varchar("contacto_email", 200)
    val contactoTelefono = varchar("contacto_telefono", 50)
    val direccion = varchar("direccion", 300)
    val activo = bool("activo").default(true)
    val nota = text("nota").nullable()          // <- NUEVO
}
